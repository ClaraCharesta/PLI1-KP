document.addEventListener("DOMContentLoaded", () => {
  ...
  const chartConfigs = [
    { id: 'activityChart', title: '[Realisasi PK - Harian] Chart Activities Category', data: activityChart },
    { id: 'statusChart', title: '[Realisasi PK - Harian] Chart Status', data: statusChart },
    { id: 'statusPersenChart', title: '[Realisasi PK - Harian] Chart Status %', data: statusPersenChart }
  ];
