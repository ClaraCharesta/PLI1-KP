...
/* ================= FORM SUBMIT (UPDATE) ================= */
const formUpdateDataBMCMPPI = document.getElementById('formUpdateDataBMCMPPI');

if (formUpdateDataBMCMPPI) {
  formUpdateDataBMCMPPI.addEventListener('submit', (e) => {
    e.preventDefault();
    
    // Ambil data dari form
    const formData = new FormData(formUpdateDataBMCMPPI);
